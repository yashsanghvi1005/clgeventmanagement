        ...
        <div class = "content"><!--body content holder-->
            ...
            <div class="row">
                <section>
                    <div class="container">
                        <div class="col-md-6">
                            <img src="images/sp.jpg" style="height: 300px; width: 550px;" class="img-responsive onstage">
                        </div>
            ...
            <div class="row">
                <section>
                    <div class="container">
                        <div class="col-md-6">
                            <img src="images/outdoor.jpg"  style="height: 300px; width: 550px;" class="img-responsive">
                        </div>
                        <div class="subcontent col-md-6">
                            <h1 style="color:#003300 ; font-size:38px ;"><strong><u>Outdoor Games</u></strong></h1>
                            <p>
                            ...
                            $id=4;
                            echo
                             '<a class="btn btn-default" href="viewEvent.php?id='.$id .'"> <span class="glyphicon glyphicon-circle-arrow-right"></span>View Outdoor Games</a>'
                        ?>
                        </div>
                    </div>
                </section>
